...
///////////////////////////////////
    ...
    function createItemForSale(address nftContract,uint256 tokenId,uint256 price)public payable nonReentrant {
        ...
        emit NftMarketItemCreated(nftContract, id, tokenId,  msg.sender, msg.sender,address(0), price, false,address(0),address(0),price,false);

    }

    //=>Update Item =>We Dont Use This

    function updateMarketItem(address nftContract,uint256 id,uint256 tokenId)
        public 
        payable
...
///FETCH SINGLE NFT
  function fetchSingleItem(uint256 id) public view returns (NftMarketItem memory)
